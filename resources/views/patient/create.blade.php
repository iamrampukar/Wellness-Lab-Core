              ...
              <form method="post" action="{{ route('patient.store') }}">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input type="email" name="email" class="form-control form-control-sm @error('email') is-invalid @enderror" placeholder="9849..." value="{{ old('email') }}">
                                @if($errors->has('email'))
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="address" class="form-control form-control-sm @error('address') is-invalid @enderror" rows="5" placeholder="Laboratory report...">{{ old('address') }}</textarea>
